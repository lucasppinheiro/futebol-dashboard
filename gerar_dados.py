...
def montar_info(
    ...
    rodada_confirmada: bool | None = None,
) -> dict[str, Any]:
    """Monta o bloco info do dashboard a partir de classificacao e artilharia."""
    jogos = [time["jogos"] for time in classificacao]
    jogos_minimos = min(jogos)
    jogos_maximos = max(jogos)
    rodada_confirmada = jogos_minimos == jogos_maximos if rodada_confirmada is None else rodada_confirmada
    rodada_atual = jogos_maximos if rodada_atual is None else rodada_atual
    campeonato_finalizado = rodada_confirmada and rodada_atual >= 38
    return {
...
def gerar_artilharia() -> list[dict[str, Any]]:
    artilheiros: list[dict[str, Any]] = [
        ...
        {"jogador": "Breno Lopes", "time": "Coritiba", "sigla": "CFC", "posicao": "Atacante", "gols": 11},
        ...
        {"jogador": "Jája Silva", "time": "Clube do Remo", "sigla": "REM", "posicao": "Atacante", "gols": 8},
    ]
...
def gerar_dados() -> None:
    ...
    dados = {
        ...
        "dados_atualizados_em": agora,
        "dados_verificados_em": agora,
